...
ggplot(data = classifications, aes(x = Classification, y = Quantity, fill = Type)) +
 ...
 coord_flip()+
 scale_fill_manual(values = c(cols[4],cols[4], cols[4],cols[2], cols[2],cols[2], cols[4],cols[2]))+
  ...
  labs(title = "Majority of homeless are temporary,\nsheltered, alone and male",
       subtitle = "Data ratifies homelessness is not a permanent experience for most people", caption = "Source: U.S. Department of Housing and Urban Development (HUD)",x = "Years")+
...
```{r fig.height = 6.5, fig.width = 6.5, results='hide', fig.keep='all', warning = F, message = F}
