...
colnames(total_sh_and_unsh)[2] <- "Unsheltered homeless"
colnames(total_sh_and_unsh)[3] <- "Sheltered homeless"
...
* For most people, homelessness is a temporary rather than a chronical experience.
...
ggplot(data = homeless_and_geog_states) + 
  ...
  labs(title = "High proportion of homeless per capita presented\nin west coast states + NY",       subtitle = "Rest of the country presents small deviations", caption = "Source: U.S. Department of Housing and Urban Development (HUD)")+
  homeless_map_theme
