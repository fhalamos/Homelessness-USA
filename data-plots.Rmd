...
ggplot(data = homeless_and_geog_states) + 
  ...
  labs(title = "High proportion of homeless per capita presented\nin west coast states + NY",       subtitle = "Rest of the country presents small deviations", caption = "Source: Source: U.S. HUD",x = "Latitue", y="Longitude")
...
ggplot(data=world) +
  ...
  labs(title = "Manhattan presents low homeless  centers considering\nhomeless population compared to other areas in city",       subtitle = "Drop in centers (blue) and Homeless Prevention Network offices (red)\nnot disrtibuted in city according to unsheltered", caption = "Source: City of New York Open Data Portal",x = "Latitue", y="Longitude")+
  homeless_theme+
  scale_fill_gradientn(
    colors = cols,
    aesthetics = "fill")
